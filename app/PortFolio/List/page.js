...
const List = ({slug,content,image,category}) => {
  return (
   <li className=''>
        ...
        <div className='px-3 mt-3 border-2 border-gray-600 rounded-lg py-4'>
          <Link href={`/PortFolio/${category}/${slug}`} className='text-white text-lg lg:text-2xl font-extrabold hover:text-purple-500 '>{content}</Link>
